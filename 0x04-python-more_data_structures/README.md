...
$ dreamdaddybanks@ubuntu:~/0x04$ ./4-main.py
...
**Solution:** [5-number_keys.py](https://github.com/dreamdaddybanks/holbertonschool-higher_level_programming/blob/master/0x04-python-more_data_structures/5-number_keys.py)
...
$ dreamdaddybanks@ubuntu:~/0x04$ ./101-main.py
[[1, 4, 9], [16, 25, 36], [49, 64, 81]]
[[1, 2, 3], [4, 5, 6], [7, 8, 9]]
$ dreamdaddybanks@ubuntu:~/0x04$
```
